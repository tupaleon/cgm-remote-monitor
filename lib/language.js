...
// food editor
    ...
    ,'No API secret hash stored yet. You need to enter API secret.' : {
      ...
      ,it: 'No API hash segreto ancora memorizzato. È necessario inserire API segreto.'
    ...
    ,'Please verify that the data entered is correct' : {
      ...
      ,it: 'Si prega di verificare che i dati inseriti sono corretti'
    ...
    ,'Use BG correction in calculation' : {
      ...
      ,it: 'Utilizzare la correzione Glicemia nei calcoli'
    ...
    ,'Use carbs correction in calculation' : {
      ...
      ,it: 'Utilizzare la correzione con carboidrati nel calcolo'
    ...
    ,'Urgent High Alarm' : {
      ...
      ,it: 'Allarme Urgente: Glicemia Molto Alta'
    ...
    ,'Urgent Low Alarm' : {
      ...
      ,it: 'Allarme Urgente. Glicemia Molto Bassa'
      ,dk: 'Advarsel: Lav'
    ...
    ,'When enabled the page will be dimmed from 10pm - 6am.' : {
      ...
      ,it: 'Attivandola, la pagina sarà oscurato da 10:00-06:00.'
    ...
    ,'Reset, and use defaults' : {
      ...
      ,it: 'Resetta e utilizza le impostazioni predefinite'
